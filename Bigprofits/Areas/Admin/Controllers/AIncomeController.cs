...
namespace Bigprofits.Areas.Admin.Controllers
{
    ...
    public class AIncomeController(ContextClass context, CommonMethods commonMethods, SqlConnectionClass dataAccess, IWebHostEnvironment webHostEnvironment, HomeRepository homeRepository) : Controller
    {
        ...
        [HttpGet("roi-income")]
        public async Task<IActionResult> ADailyROI(int? page, string? userId, string? date, string? date1)
        {
            ...
            {
                string url = $"/britglbl253adpnl/roi-income?";
        ...
        public async Task<IActionResult> SponsorIncome(int? page, string? userId, string? date, string? date1)
        {
            ViewBag.userId = userId;
            ViewBag.date = date;
            ViewBag.date1 = date1;
            ...
            par.Add(new SqlParameter("@hashId", "SPONSOR"));
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                string url = $"/britglbl253adpnl/sponsor-income?";
                if (userId != null) url += $"userId={userId}&";
                if (date != null) url += $"date={date}&";
                if (date1 != null) url += $"date={date1}&";
                url += $"page=";
        ...
        [HttpGet("additional-income")]
        public async Task<IActionResult> AchiverIncome(int? page, string? userId, string? date, string? date1)
        {
            ViewBag.userId = userId;
            ViewBag.date = date;
            ViewBag.date1 = date1;
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                string url = $"/britglbl253adpnl/additional-income?";
                if (userId != null) url += $"userId={userId}&";
                if (date != null) url += $"date={date}&";
                if (date1 != null) url += $"date={date1}&";
                url += $"page=";
        ...
        public async Task<IActionResult> BinaryIncome(int? page, string? userId, string? date, string? date1)
        {
            ViewBag.userId = userId;
            ViewBag.date = date;
            ViewBag.date1 = date1;
            ...
            par.Add(new SqlParameter("@rtype", "BINARY INCOME RETURN"));
            var ds = await _dataAccess.FnRetriveByPro("[SP_ShowHistory]", par);
            ViewBag.data = ds;

            if (ds.Tables[0].Rows.Count > 0)
            {
                string url = $"/britglbl253adpnl/matching-income?";
                if (userId != null) url += $"userId={userId}&";
                if (date != null) url += $"date={date}&";
                if (date1 != null) url += $"date={date1}&";
                url += $"page=";
        ...
        [HttpGet("matching-history")]
        public async Task<IActionResult> Bonusincome(int? page, string? userId, string? date, string? date1)
        {
            ViewBag.userId = userId;
            ViewBag.date = date;
            ViewBag.date1 = date1;
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                string url = $"/britglbl253adpnl/matching-history?";
                if (userId != null) url += $"userId={userId}&";
                if (date != null) url += $"date={date}&";
                if (date1 != null) url += $"date={date1}&";
                url += $"page=";
